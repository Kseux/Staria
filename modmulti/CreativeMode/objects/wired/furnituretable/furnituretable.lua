...
world.logInfo("furnituretable.lua:init(): furniture box has done its init")
...
function onInteraction(args)
  ...
  ["paneLayout"] = {
    ...
    ["background"] = {
      ["type"] = "background",
      ["fileHeader"] = "/interface/furnituretable/craftingheader.png",
      ["fileBody"] = "/interface/furnituretable/craftingbody.png",
      ["fileFooter"] = "/interface/furnituretable/craftingfooter.png"
    },
    ["close"] = {
      ["type"] = "button",
    ...
    ["windowtitle"] = {
      ["type"] = "title",
      ["title"] = "  FURNITURE BOX",
      ["subtitle"] = "  Take a seat!",
      ["position"] = {-5, 252},
      ["icon"] = {
        ["type"] = "image",
        ["file"] = "/interface/furnituretable/craftingtable.png",
        ["position"] = {0, -20},
        ["zlevel"] = -1
      }
    },
    ...
    ["scrollArea"] = {
      ...
      ["children"] = {
        ["itemList"] = {
          ["type"] = "list",
          ["schema"] = {
            ["selectedBG"] = "/interface/furnituretable/craftableselected.png",
            ["unselectedBG"] = "/interface/furnituretable/craftablebackground.png",
            ["spacing"] = {0, 1},
            ["memberSize"] = {156, 20},
            ["listTemplate"] = {
              ["background"] = {
                ["type"] = "image",
                ["file"] = "/interface/furnituretable/craftablebackground.png",
                ["position"] = {0, 0},
                ["zlevel"] = -1
              },
              ["itemName"] = {
...
local b = {
  ...
  for _,bt in ipairs(buttons) do
    ...
    if num > buttonArrayMaxWidth*buttonArrayMaxHeight then 
      fullLabel = {
        ["type"] = "image",
        ["file"] = "/interface/furnituretable/maxbuttons.png",
    ...
    if not bt["baseImage"] then bt["baseImage"] = "/interface/furnituretable/iconmissing.png" end
    if not bt["baseImageChecked"] then bt["baseImageChecked"] = "/interface/furnituretable/iconmissingchecked.png" end
