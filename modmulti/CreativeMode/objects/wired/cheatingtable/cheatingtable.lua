...
world.logInfo("cheatingtable.lua:init(): ultimate box has done its init")
...
function onInteraction(args)
  ...
  ["paneLayout"] = {
    ...
    ["background"] = {
      ["type"] = "background",
      ["fileHeader"] = "/interface/cheatingtable/craftingheader.png",
      ["fileBody"] = "/interface/cheatingtable/craftingbody.png",
      ["fileFooter"] = "/interface/cheatingtable/craftingfooter.png"
    },
    ["close"] = {
      ["type"] = "button",
    ...
    ["windowtitle"] = {
      ["type"] = "title",
      ["title"] = "  ULTIMATE BOX",
      ["subtitle"] = "  Totally not cheating.",
      ["position"] = {-5, 252},
      ["icon"] = {
        ["type"] = "image",
        ["file"] = "/interface/cheatingtable/craftingtable.png",
        ["position"] = {0, -20},
        ["zlevel"] = -1
      }
    },
    ...
    ["scrollArea"] = {
      ...
      ["children"] = {
        ["itemList"] = {
          ["type"] = "list",
          ["schema"] = {
            ["selectedBG"] = "/interface/cheatingtable/craftableselected.png",
            ["unselectedBG"] = "/interface/cheatingtable/craftablebackground.png",
            ["spacing"] = {0, 1},
            ["memberSize"] = {156, 20},
            ["listTemplate"] = {
              ["background"] = {
                ["type"] = "image",
                ["file"] = "/interface/cheatingtable/craftablebackground.png",
                ["position"] = {0, 0},
                ["zlevel"] = -1
              },
              ["itemName"] = {
...
local b = {
  ...
  for _,bt in ipairs(buttons) do
    ...
    if num > buttonArrayMaxWidth*buttonArrayMaxHeight then 
      fullLabel = {
        ["type"] = "image",
        ["file"] = "/interface/cheatingtable/maxbuttons.png",
    ...
    if not bt["baseImage"] then bt["baseImage"] = "/interface/cheatingtable/iconmissing.png" end
    if not bt["baseImageChecked"] then bt["baseImageChecked"] = "/interface/cheatingtable/iconmissingchecked.png" end
