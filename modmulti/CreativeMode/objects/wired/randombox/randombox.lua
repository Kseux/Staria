...
world.logInfo("randombox.lua:init(): ultimate box has done its init")
...
function onInteraction(args)
  ...
  ["paneLayout"] = {
    ...
    ["background"] = {
      ["type"] = "background",
      ["fileHeader"] = "/interface/randombox/craftingheader.png",
      ["fileBody"] = "/interface/randombox/craftingbody.png",
      ["fileFooter"] = "/interface/randombox/craftingfooter.png"
    },
    ["close"] = {
      ["type"] = "button",
    ...
    ["windowtitle"] = {
      ["type"] = "title",
      ["title"] = "  RANDOM WEAPONS BOX",
      ["subtitle"] = "  Screw RNG.",
      ["position"] = {-5, 252},
      ["icon"] = {
        ["type"] = "image",
        ["file"] = "/interface/randombox/craftingtable.png",
        ["position"] = {0, -20},
        ["zlevel"] = -1
      }
    },
    ...
    ["scrollArea"] = {
      ...
      ["children"] = {
        ["itemList"] = {
          ["type"] = "list",
          ["schema"] = {
            ["selectedBG"] = "/interface/randombox/craftableselected.png",
            ["unselectedBG"] = "/interface/randombox/craftablebackground.png",
            ["spacing"] = {0, 1},
            ["memberSize"] = {156, 20},
            ["listTemplate"] = {
              ["background"] = {
                ["type"] = "image",
                ["file"] = "/interface/randombox/craftablebackground.png",
                ["position"] = {0, 0},
                ["zlevel"] = -1
              },
              ["itemName"] = {
...
local b = {
  ...
  for _,bt in ipairs(buttons) do
    ...
    if num > buttonArrayMaxWidth*buttonArrayMaxHeight then 
      fullLabel = {
        ["type"] = "image",
        ["file"] = "/interface/randombox/maxbuttons.png",
    ...
    if not bt["baseImage"] then bt["baseImage"] = "/interface/randombox/iconmissing.png" end
    if not bt["baseImageChecked"] then bt["baseImageChecked"] = "/interface/randombox/iconmissingchecked.png" end
